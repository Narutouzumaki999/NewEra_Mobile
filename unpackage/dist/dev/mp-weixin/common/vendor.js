...
var chgSpecialToText = function chgSpecialToText(text) {
  text = text.replace(/&amp;/g, "&");
  text = text.replace(/&lt;/g, "<");
  text = text.replace(/&gt;/g, ">");
  text = text.replace(/&quot;/g, '"');
  ...
  return text;
};exports.chgSpecialToText = chgSpecialToText;

var checkAuth = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            data = {
            ...
            uni.request({
              ...
              } });case 2:case "end":return _context.stop();}}}, _callee);}));return function checkAuth() {return _ref.apply(this, arguments);};}();exports.checkAuth = checkAuth;
